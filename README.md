...
Може знадобитись 1-2 хвилини бо деякі контейнери підіймаються тільки після того як готов інший контейнер (наприклад php чекає коли буде готовий mysql)
...
- Додав би переклади для різних мов
- Можно подумати стосовно того щоб винести деякий код Nuxt і Vue в окремі файли
